...
set _DeploySetParametersFile=%RootPath%Leet.Kantilever.FEWebwinkel.Site.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Leet.Kantilever.FEWebwinkel.Site.zip" (
echo "%RootPath%Leet.Kantilever.FEWebwinkel.Site.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Leet.Kantilever.FEWebwinkel.Site.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Leet.Kantilever.FEWebwinkel.Site.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Leet.Kantilever.FEWebwinkel.Site.deploy-readme.txt" (
...
start notepad "%RootPath%Leet.Kantilever.FEWebwinkel.Site.deploy-readme.txt"
)
echo =========================================================
goto :eof
