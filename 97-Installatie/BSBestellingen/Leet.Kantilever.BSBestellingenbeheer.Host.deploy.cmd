...
set _DeploySetParametersFile=%RootPath%Leet.Kantilever.BSBestellingenbeheer.Host.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Leet.Kantilever.BSBestellingenbeheer.Host.zip" (
echo "%RootPath%Leet.Kantilever.BSBestellingenbeheer.Host.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Leet.Kantilever.BSBestellingenbeheer.Host.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Leet.Kantilever.BSBestellingenbeheer.Host.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Leet.Kantilever.BSBestellingenbeheer.Host.deploy-readme.txt" (
...
start notepad "%RootPath%Leet.Kantilever.BSBestellingenbeheer.Host.deploy-readme.txt"
)
echo =========================================================
goto :eof
